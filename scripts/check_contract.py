#!/usr/bin/env python3
"""Fail CI when the public demo contract drifts from its 20 operations."""
...
def main() -> None:
    ...
    if actual != EXPECTED_OPERATIONS:
        ...
        raise SystemExit(
            "API contract drifted from 20 operations. "
            f"Missing: {missing or 'none'}; unexpected: {unexpected or 'none'}"
        )
    print("PASS: OpenAPI exposes the exact 20-operation hackathon contract")
